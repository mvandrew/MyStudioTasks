...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПрочитатьТабличныйДокументИзХранилища(ТабличныеДокументыДляСравнения.Левый, ТабличныйДокументЛевый);
	ПрочитатьТабличныйДокументИзХранилища(ТабличныеДокументыДляСравнения.Правый, ТабличныйДокументПравый);
...
&НаСервере
Процедура ПрочитатьТабличныйДокументИзХранилища(ДокументВХранилище, Документ)
	ВременныйФайл  = ПолучитьИмяВременногоФайла("mxl");
	ДвоичныеДанные = ПолучитьИзВременногоХранилища(ДокументВХранилище);
	ДвоичныеДанные.Записать(ВременныйФайл);
	Документ.Прочитать(ВременныйФайл);
