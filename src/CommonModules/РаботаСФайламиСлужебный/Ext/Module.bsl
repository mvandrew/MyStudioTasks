...
//
// Параметры:
//  СтруктураHref          - Структура - Описание параметров подключения.
//  ПараметрыСинхронизации - Структура - Параметры подключения: логин и пароль.
//  Таймаут                - Число     - Определяет время ожидания осуществляемого соединения и операций, в секундах.
//
// Возвращаемое значение:
//  HTTPСоединение - Установленное соединение.
//
...
Функция ВызватьМетодGET(Href, Etag, ПараметрыСинхронизации, ДатаМодификацииФайла = Неопределено, ДлинаФайла = Неопределено)
	...
	Таймаут = ?(ДлинаФайла <> Неопределено, РассчитатьТаймаут(ДлинаФайла), 43200); // размер в мегабайтах * 128 или 12 часов.
