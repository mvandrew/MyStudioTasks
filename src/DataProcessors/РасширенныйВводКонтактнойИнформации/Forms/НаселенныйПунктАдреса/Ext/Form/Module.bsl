...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЧастиАдреса = Неопределено Или ЧастиАдреса.Количество() = 0 Тогда
		ЧастиАдреса = Обработки.РасширенныйВводКонтактнойИнформации.СписокРеквизитовНаселенныйПункт( , ФорматАдреса);
	КонецЕсли;
...
Функция РезультатВыбора()
	...
	Результат.Вставить("Представление", РаботаСАдресамиКлиентСервер.ПредставлениеНаселенногоПунктаПоЧастямАдреса(ЧастиАдреса));
