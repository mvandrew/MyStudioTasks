...
Процедура ОбновитьНастройкиСинхронизации()
	...
	Для каждого ОбъектИсключение Из МассивИсключений Цикл
		НайденнаяСтрока = ТаблицаВладельцевФайлов.Найти(ОбщегоНазначения.ИдентификаторОбъектаМетаданных(ОбъектИсключение), "ВладелецФайла");
		Если НайденнаяСтрока <> Неопределено Тогда
			ТаблицаВладельцевФайлов.Удалить(НайденнаяСтрока);
		КонецЕсли;
	КонецЦикла;
